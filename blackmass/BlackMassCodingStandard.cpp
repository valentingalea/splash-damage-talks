...
#include "BlackMassCodingStandard.h"
...
{
	static void PrivateHelper(const UBMCodingStandardExampleComponent& Object)
	{
...
float DoPassBlueprintVarStructs(const FBMCodingStandardBlueprintVarGroup &vars)
{
...
void ABMCodingStandardExampleActor::BeginPlay()
{
...
void ABMCodingStandardExampleActor::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	Super::GetLifetimeReplicatedProps(OutLifetimeProps);

	DOREPLIFETIME(ABMCodingStandardExampleActor, WantsToSprint);
}

void ABMCodingStandardExampleActor::OnRep_WantsToSprint()
{
}

void UBMCodingStandardExampleComponent::LambdaStyle(AActor *ExternalEntity)
{
...
static void EnumString()
{
	...
	constexpr auto NumValues = EnumAutoGen::GetNumValues<EBMCodingStandardEnum>();
	...
	constexpr auto * ValueAString = EnumAutoGen::GetEnumString(EBMCodingStandardEnum::ValueA);
	...
	EnumAutoGen::ForEachPair<EBMCodingStandardEnum>(
		[](EBMCodingStandardEnum Value, const TCHAR * String)
	{
		// Do something
	});
}

// NOTE: for a quick refresher on C++11/14 see our Splash Academy
// http://splashlanding/Docs/Programmers/Valentin/cpp11-14-presentation.html

void BMBlackMassCodingStandardHelpers::PublicHelper(const UBMCodingStandardExampleComponent& Object)
{

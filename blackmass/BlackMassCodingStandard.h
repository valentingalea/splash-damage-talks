...
#include "BlackMassCodingStandard.generated.h"
...
public:
	...
	~ABMCodingStandardExampleActor() = default; // or just remove
...
enum class EBMCodingStandardEnum // `: uint8` optional underlying type 
{
	ValueA,
	ValueB,
	ValueC,
	...
	// use EnumAutoGen::GetNumValues<EBMCodingStandardEnum>() instead.
	Max /* <- BAD */
};

UCLASS()
class UBMCodingStandardExampleComponent : public USceneComponent
{
	GENERATED_BODY()
...
public:
	...
	/* BAD -> */ static UBMCodingStandardExampleComponent* Instance; // defined in .cpp
	/* VERY BAD -> */ UBMCodingStandardExampleComponent* GetInstance() { return Instance; }
	...
	friend inline bool operator == (
		const UBMCodingStandardExampleComponent &lhs,
		const UBMCodingStandardExampleComponent &rhs);

protected:
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly)
	FBMCodingStandardBlueprintVarGroup BlueprintGroup;
...
inline TWeakObjectPtr<USkeletalMeshComponent> ABMCodingStandardExampleActor::GoodExampleOfInline()
{
	return OtherMesh;
}
...
namespace BMBlackMassCodingStandardHelpers
{
	void PublicHelper(const UBMCodingStandardExampleComponent& Object);
}

// [module.naming] when adding new module folders to the code base follow our naming convention
...
//	- Interfaces in Interface modules should be prefixed with BI
//	- Classes, Struct & Enums in Interface modules should be prefixed with BC
//	- Interfaces in Core modules should be prefixed with BC
//	- Classes, Struct & Enums in Core modules should be prefixed with BC
//	- Interfaces in Game modules should be prefixed with BM
//	- Classes, Struct & Enums in Game modules should be prefixed with BM

// [module.naming.namespace]
// - Namespaces in Core modules should be prefixed with BC
// - Namespaces in Game modules should be prefixed with BM
